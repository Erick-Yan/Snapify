from flask import Blueprint, url_for, session, redirect, request, jsonify, abort, make_response
...
def login():
    ...
    parameters = 'response_type=code&client_id=' + CLIENT_ID + '&redirect_uri=' + REDIRECT_URI + '&scope=' + SCOPES + '&state=' + state_key + '&show_dialog=True'
